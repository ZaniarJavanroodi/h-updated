 ...
 * @author Zaniar
 */
public class AdminCrud extends javax.swing.JPanel {

    /**
     * Creates new form AdminCrud
     */
    AdminDirectory ausers;
    public AdminCrud(AdminDirectory admin) {
        initComponents();
        this.ausers = admin;
        populateTabel(ausers);
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(ViewButton, javax.swing.GroupLayout.DEFAULT_SIZE, 53, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
...
public void populateTabel(AdminDirectory users) {
        DefaultTableModel model =  (DefaultTableModel) UserTable.getModel();
        model.setRowCount(0);
        for (Admin u: users.getAllusers()){
