...
public class PatientCrud extends javax.swing.JPanel {
    ...
    public PatientCrud(PatientDirectory patient) {
        initComponents();
        this.pusers = patient;
        populateTabel(pusers);
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(ViewButton, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
...
public void populateTabel(PatientDirectory users) {
        DefaultTableModel model =  (DefaultTableModel) UserTable.getModel();
        model.setRowCount(0);
        for (Patient u: users.getAllusers()){
